...
from src.algorithm.imageclassification.bow_svm_image_classification_linear_kernel_algorithm import BowSVMImageClassificationLinearKernelAlgorithm
from src.resource.image.image import Image

__author__ = 'Iván de Paz Centeno'


class BowSVMImageClassificationLinearKernelAlgorithmTest(unittest.TestCase):

    def setUp(self):

        self.algorithm = BowSVMImageClassificationLinearKernelAlgorithm()
