...
class Kovak2003UDSkinDetectionAlgorithmTest(unittest.TestCase):

    def setUp(self):
        self.algorithm = Kovak2003UDSkinDetectionAlgorithm()
        ...
        self.sample_image_to_compare_with = [
            ...
            [Image("samples/skin_image_white.jpg"), True]]

        self.accuracy_threshold = 41.0
