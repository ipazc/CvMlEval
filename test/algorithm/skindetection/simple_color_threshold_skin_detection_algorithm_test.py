...
class SimpleColorThresholdSkinDetectionAlgorithmTest(unittest.TestCase):

    def setUp(self):
        self.algorithm = SimpleColorThresholdSkinDetectionAlgorithm()
        ...
        self.sample_image_to_compare_with = [
            ...
            [Image("samples/skin_image_black.jpg"), False],
            [Image("samples/skin_image_white.jpg"), False]]

        self.accuracy_threshold = 82.0
