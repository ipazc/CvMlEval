...
class GaussianDistributedSkinDetectionAlgorithmTest(unittest.TestCase):

    def setUp(self):
        self.algorithm = GaussianDistributedSkinDetectionAlgorithm()
