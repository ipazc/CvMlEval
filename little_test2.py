...
age_estimation_service = ImageAlgorithmService(APIRESTAgeEstimationAlgorithm, pool_limit=2,
                                               api_url='https://vision.sockhost.net:6080/estimation-requests/age/face/stream?service=gpu-cnn-depaz-full-age-estimation',
                                               name="depaz_cnn_full_age", description="De Paz Apparent age estimation")
