...
class AlgorithmPool(object):
    ...
    """
    def __init__(self, algorithm, pool_limit, *algorithm_args, **algorithm_kwargs):
        ...
        self.pool = Pool(processes=pool_limit, initializer=self.__init_pool_worker__, initargs=(algorithm,
                                                                                                algorithm_kwargs,
                                                                                                *algorithm_args))
    ...
    @staticmethod
    def __init_pool_worker__(algorithm, algorithm_kwargs, *algorithm_args):
        """
        ...
        algorithm_detector = algorithm(*algorithm_args, **algorithm_kwargs)
