...
class ImageAlgorithmService(Service, AlgorithmPool):
    ...
    def __init__(self, algorithm, pool_limit=None, *algorithm_args, **algorithm_kwargs):
        """
        ...
        AlgorithmPool.__init__(self, algorithm, pool_limit, *algorithm_args, **algorithm_kwargs)
